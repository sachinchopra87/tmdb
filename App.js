  ...
  movieNameInputSubmitted() {
    ...
    //console.log(json.results[0]);
      ...
      this.setState({
        ...
        movieBackdrop: json.results[0].backdrop_path,
        movieTitle: json.results[0].original_title,
        movieVotes: json.results[0].vote_average,
        movieOverview: json.results[0].overview
      });
  ...
  render() {
    return (
      <View style={styles.container}>
        ...
        {this.state.movieTitle && <Movie
          poster={this.state.moviePoster}
          backdrop={this.state.movieBackdrop}
          title={this.state.movieTitle}
          votes={this.state.movieVotes}
